...
Angular is designed with standalone components in mind, so each page will be a component (although this is mostly a static site, I thought it would be fun to make use of the modular nature)